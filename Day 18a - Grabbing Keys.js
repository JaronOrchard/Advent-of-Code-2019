  ...
  while (boardStates.length > 0) {
    ...
    while (cellsToVisit.length > 0) {
      ...
      if (boardState.board_state[cellIndex] >= "a" && boardState.board_state[cellIndex] <= "z") {
        keyMap[boardState.board_state[cellIndex]] = cellDist;
    ...
    for (key in keyMap) {
      ...
      // Navigate to key:
      tempBoardState.board_state = tempBoardState.board_state.replaceAt(tempBoardState.board_state.indexOf("@"), ".");
      tempBoardState.board_state = tempBoardState.board_state.replaceAt(tempBoardState.board_state.indexOf(key), "@");
      // Unlock door on map:
      ...
      // Add steps:
      tempBoardState.steps_taken += Number(keyMap[key]);
      // Check if done:
